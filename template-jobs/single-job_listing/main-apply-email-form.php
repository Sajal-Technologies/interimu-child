...
<?php if ( ! empty( $author_email ) ) : ?>
	...
	<div class="inner">
	    ...
	    <form id="job-apply-email-main-form-<?php echo esc_attr($post->ID); ?>" class="job-apply-email-form" method="post" action="" enctype="multipart/form-data">
	    	<div class="row">
				...
				<div class="col-xs-12">
			        <div class="form-group" style="margin-bottom:6px !important;"> 
			            <input type="number" class="form-control style2" name="number" placeholder="<?php esc_attr_e( 'Hourly Rate', 'superio' ); ?>">
			        </div><!-- /.form-group -->
                    
                    <p style="font-size: smaller;"> <?php esc_attr_e( 'Geef hier het all-in uurtarief waarmee je voorgesteld wilt worden, inclusief onze fee (10% bij ZZP, 15% bij detachering) exclusief BTW', 'superio' ); ?> </p>
						...
						<div class="form-group">
							<label for="register-terms-and-conditions">
								...
								<?php
									...
									echo sprintf(wp_kses(__('You accept ours <a href="%s" target="_blank">Terms and Conditions and Privacy Policy</a>', 'superio'), $allowed_html_array), esc_url($page_url));
								?>
							</label>
						</div>
					</div>
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <div style="background-color: #e8f0fe; padding: 10px; border-radius: 5px; margin-top: 20px;">
                            <div style="display: flex; align-items: start;">
                                <input type="checkbox" id="agreement" name="agreement"
                                    style="margin-right: 10px; margin-top: 4px;" required> 
                                <div>
                                    <b style="color: #1967d2;">Akkoord geen bemiddeling voor
                                        derden</b>
                                    <p style="margin: 0; color: #1967d2;">Wij streven naar een korte en heldere
                                        inhuurketen. Daarom werken we direct samen
                                        met zelfstandige professionals en niet via
                                        bemiddelingsbureaus.</p>
                                </div>
                            </div>
                        </div>
                    </div>
