...
$location = superio_child_job_display_short_location($post, 'no-icon', false);
    ...
    <ul class="list">
        ...
        <?php if ( $location ) { ?>
            <li>
                ...
                <div class="details">
                    <div class="text"><?php echo trim(esc_html_e($meta_obj->get_post_meta_title('location'), 'superio' )); ?></div>
